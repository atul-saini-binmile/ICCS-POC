...
const SingleLineFormInput = (props: IFormInput) => {
  ...
  const onSubmit = (data: any) => {
    handleFormBuild(FormType.SINGLE_LINE_TEXT, {
  ...
  return (
    <div className={styles.container}>
      <h3 className={styles.title}>Single Line Input</h3>
...
export default SingleLineFormInput;
